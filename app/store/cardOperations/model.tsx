...
import { formatedTransferCardTokenRequestParams, formatedCardInfoRequestParams, formatedTransferInfoRequestParams } from './parser';
...
export const cardOperations = {
  ...
  effects: dispatch => ({
    pushCardField: createLoggedAsyncAction<ITransferField, void>(
      async (params: ITransferField) => {
