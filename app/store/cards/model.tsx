...
import { ICardsState, ICardField, IStoreState, ICreateCardData, ICard, ICardsData, IVerifyCardData, IActiveCard, IMessageError, ICardBalance, ICardBalanceData, VisaCurrencyType, IChangeVisaVirtualParams } from 'types';
import { createLoggedAsyncAction, isFieldErrorExist, isCreateCardErrorExist, setCreateCardFieldValue, isUnauthenticated } from 'utils';
import { callCreateCard, callCards, callVerifyCard, callCardsBalance, callChangeVisaVirtualStatus } from './request';
import { formatedCreateCardRequestParams, formatedVerifyCardRequestParams, formatedCardBalanceRequestParams } from './parser';
...
export const cards = {
  ...
  reducers: {
    ...
    pushCreateVisaVirtualDone: (state: ICardsState, payload: ICard): ICardsState => {
      return { ...state, createVisaVirtual: payload, createVisaVirtualIsFetching: false, createVisaVirtualIsError: false };
    },
    ...
    pushChangeVisaStatusDone: (state: ICardsState, payload: ICard[]): ICardsState => {
      return { ...state, cards: payload, changeVisaVirtualStatusIsFetching: false, changeVisaVirtualStatusIsError: false };
    },
