...
import { ACCEPT_LANGUAGE, LIST_CARDS, AUTHORIZATION, TOKEN_CREATE_QWERTY, TOKEN_VERIFY_QWERTY, CARDS_BALANCE, CREATE_VISA_VIRTUAL, VISA_CARD_INFO, CREATE_SUM_VISA_VIRTUAL, CREATE_VISA_DUPLICATE, VISA_ACTIVATION } from "api";
import { ICreateCardData, ICreateCardParams, ICardsData, IVerifyCardData, IVerifyCardParams, ICardBalanceParams, ICreateVisaVirtualParams, IVisaCardInfoParams, IChangeVisaVirtualParams } from "types";
import { Locale, USER_TOKEN } from "const";

export async function callCreateCard(params: ICreateCardParams) {
  return apiQwerty.post<ICreateCardData>(
    TOKEN_CREATE_QWERTY,
    params,
    {
      headers: {
...
export async function callVerifyCard(params: IVerifyCardParams) {
  return apiQwerty.post<IVerifyCardData>(
    TOKEN_VERIFY_QWERTY,
    params,
    {
      headers: {
...
export async function callCards() {
  ...
  return apiQwerty.get<ICardsData>(
    LIST_CARDS,
    {
      headers: {
        [AUTHORIZATION]: await AsyncStorage.getItem(USER_TOKEN),
...
export async function callCardsBalance(params: ICardBalanceParams) {
  return apiQwerty.post<ICardsData>(
    CARDS_BALANCE,
    params,
    {
      headers: {
