...
export function CardOperationsTransferFooterButtonsView({ transferIsFetching, transfer, cancel }: IOwnProps) {
	return (
			...
			>
				...
				>
					{transferIsFetching ? (
						...
						<Text style={styles.transferButtonTitle}>{strings("transfer")}</Text>
					)}
				</LinearGradient>
			</TouchableOpacity>
		</View>
