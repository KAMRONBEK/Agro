...
export function Signup2SecondStepView({
  phone,
  formatedPhone,
  code,
  onChange
  ...
  return (
    <View style={styles.container}>
      <View style={styles.phoneBox}>
        ...
        />
        {
          !!phone.errors.length && <View style={styles.phoneErrorBox}>
            {phone.errors.map(renderError)}
          </View>
        }
      </View>
      ...
      <View style={styles.form}>
        ...
        />
        {
          !!code.errors.length && <View style={styles.errorBox}>
            {code.errors.map(renderError)}
          </View>
        }
      </View>
