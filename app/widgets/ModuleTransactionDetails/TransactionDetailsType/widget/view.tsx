...
export function TransactionDetailsTypeView({ details, detailsIsFetching }: IOwnProps) {
		...
		return (
			<View style={styles.typeBox}>
				...
				<View
					style={[
						styles.typeLogoBox,
						details?.type === ITransactionType.Transfer && styles.typeLogoTransferBox,
					]}
				>
	...
	function renderContent() {
		return <View style={styles.content}>{renderType()}</View>;
	}
	...
	return <View style={styles.container}>{!detailsIsFetching ? renderContent() : renderActivityLoader()}</View>;
}
