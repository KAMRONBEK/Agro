...
export function SettingsLogoutModalView({
  isVisible,
  logoutIsFetching,
  close,
  logout
    ...
    >
      <View style={styles.content}>
        ...
        <View style={styles.buttons} >
          <TouchableOpacity onPress={logout} disabled={logoutIsFetching} activeOpacity={TOUCHABLE_OPACITY} style={styles.buttonYes}>
          ...
          <TouchableOpacity disabled={logoutIsFetching} onPress={close} activeOpacity={TOUCHABLE_OPACITY} style={styles.buttonNo}>
